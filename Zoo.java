...
public class Zoo{ //create class Zoo
  ...
  public static void main(String[] args) { //main
    ...
    Enclosure AWS = new Enclosure("Annie Wright", 100000);
    ...
    if(answer.equals ("monkeys")||answer.equals("Monkeys")){ //if user wants to see monkeys
      ...
      System.out.println("And the temperature of that enclosure is "+ mon2 + ".");
    }
      ...
      System.out.println("And the temperature of that enclosure is "+ mon4 + ".");
    }
      ...
      System.out.println("And the temperature of AWS is "+ mon6 + ".");
    }
